...
public class BoardManager {
	...
	public BoardManager(int _id, Boolean _useTeams) {
		...
		if (useTeams) {
			for (com.cloudcraftgaming.novagameslib.api.team.Team team : com.cloudcraftgaming.novagameslib.api.team.Team.allTeams()) {
				Team boardTeam = scoreboard.registerNewTeam(team.name());
				boardTeam.setDisplayName(com.cloudcraftgaming.novagameslib.api.team.Team.getColor(team) + team.name());
	 ...
	 * Use {@link #addPlayerToScoreboard(Player, com.cloudcraftgaming.novagameslib.api.team.Team)} to add a player to the scoreboard.
	 ...
	 * @return <code>true</code> is successful, else <code>false</code>.
	 */
	public Boolean addPlayerToScoreboard(Player player, com.cloudcraftgaming.novagameslib.api.team.Team team) {
		if (useTeams) {
	 ...
	 * Use {@link #addPlayerToScoreboard(Player, com.cloudcraftgaming.novagameslib.api.team.Team)} to add a player to a scoreboard with teams.
	 * Use {@link #addSpectatorToScoreboard(Player)} to add a spectator to the scoreboard.
	 * @param player The player to add.
	 * @return <code>true</code> if successful, else <code>false</code>.
	 */
	 ...
	 * Use {@link #removePlayerFromScoreboard(Player, com.cloudcraftgaming.novagameslib.api.team.Team)} to remove a player rather than a spectator.
	 ...
	 * @return <code>true</code> if successful, else <code>false</code>.
	 */
	public Boolean removePlayerFromScoreboard(Player player, com.cloudcraftgaming.novagameslib.api.team.Team team) {
		if (useTeams) {
			Team boardTeam = scoreboard.getTeam(team.name());
	 ...
	 * Use {@link #removePlayerFromScoreboard(Player, com.cloudcraftgaming.novagameslib.api.team.Team)} to remove from a specific team.
	 * Use {@link #removeSpectatorFromBoard(Player)} to remove a spectator rather than a player.
	 * @param player The player to remove.
	 * @return <code>true</code> if successful, else <code>false</code>.
	 */
